...
train_args = {"regions1_train": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site1_train_dist_matched_thres10_15kb.bed"), 
              "regions2_train": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site2_train_dist_matched_thres10_15kb.bed"),
              "regions1_test": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site1_test_dist_matched_thres10_15kb.bed"),
              "regions2_test": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site2_test_dist_matched_thres10_15kb.bed"),
              "labels_train": np.load("/users/mtaranov/3D_fromATAC_by_chr/labels/labels_train_dist_matched_thres10.npy"),
              "labels_test": np.load("/users/mtaranov/3D_fromATAC_by_chr/labels/labels_test_dist_matched_thres10.npy"),

...
from genomedatalayer.extractors import FastaExtractor, MemmappedBigwigExtractor, MemmappedFastaExtractor
...
#train_args = {"regions1_train": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site1_train_dist_matched_thres10.bed"),
#              "regions2_train": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site2_train_dist_matched_thres10.bed"),
#              "regions1_test": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site1_test_dist_matched_thres10.bed"),
#              "regions2_test": BedTool("/users/mtaranov/3D_fromATAC_by_chr/labels/site2_test_dist_matched_thres10.bed"),


train_args = {"regions1_train": BedTool("/users/mtaranov/get_atac_contacts/data/labels/site1_train_dist_matched_thres10.bed"), 
              "regions2_train": BedTool("/users/mtaranov/get_atac_contacts/data/labels/site2_train_dist_matched_thres10.bed"),
              "regions1_test": BedTool("/users/mtaranov/get_atac_contacts/data/labels/site1_test_dist_matched_thres10.bed"),
              "regions2_test": BedTool("/users/mtaranov/get_atac_contacts/data/labels/site2_test_dist_matched_thres10.bed"),
              "labels_train": np.load("/users/mtaranov/get_atac_contacts/data/labels/labels_train_dist_matched_thres10.npy"),
              "labels_test": np.load("/users/mtaranov/get_atac_contacts/data/labels/labels_test_dist_matched_thres10.npy"),

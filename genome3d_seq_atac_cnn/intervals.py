...
def train_test_chr_split(intervals1, intervals2, labels, test_chr):
    train_intervals1 = []
    train_intervals2 = []
    train_labels = []
    test_intervals1 = []
    test_intervals2 = []
    test_labels = []
    for interval1,interval2, label in zip(intervals1, intervals2, labels):
        if interval1.chrom in test_chr and interval2.chrom in test_chr:
            test_intervals1.append(interval1)
            test_intervals2.append(interval2)
            test_labels.append(label)
        else:
            train_intervals1.append(interval1)
            train_intervals2.append(interval2)
            train_labels.append(label)
    train_labels = np.array(train_labels)
    test_labels = np.array(test_labels)

    return (train_intervals1, test_intervals1, train_intervals2, test_intervals2, train_labels, test_labels)
